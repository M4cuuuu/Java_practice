...
public static void main(String[] args) {
        ...
        //list of course details from class Course
    ...
    // Print course names
    String formattedUnits = String.format("\t%-1s\t%-40s\t%-10s\t%-6s",cc,cn,u,s);
    ...
    System.out.println(formattedUnits);
                ...
                for (int i = 0; i < course.length; ++i) {
                    String formattedOutput = String.format("\t%-8s\t%-45s\t%-10d %s%s", course[i].courseCode, course[i].courseName, course[i].units,timeSchedA[i],day[i]);
